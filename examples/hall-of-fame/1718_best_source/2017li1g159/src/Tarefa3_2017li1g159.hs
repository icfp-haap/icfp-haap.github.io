{-|
Module : Tarefa 3
Description : Tarefa 3 Trabalho prático.
...
module Tarefa3_2017li1g159 where
...
dicInWall tab vi o z ti  | z >= 0     = Nothing 
                         | otherwise  =  branch tab ( Carro  ( segue (velocidade vi) ndt (posicao vi) ) (direcao vi) (collision (velocidade vi) o) ) (ti - ndt) (pelc vi)
